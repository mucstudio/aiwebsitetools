...
export function ShareResult({
    ...
    return (
        <Card className={cn("mt-6 border-dashed backdrop-blur-sm", className)}>
            <CardContent className="pt-6 pb-6">
                <div className="flex flex-col gap-6">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                        ...
                        <div className="flex items-center gap-3 w-full sm:w-auto">
                            ...
                            <Button
                                ...
                                className="flex-1 sm:flex-none shadow-sm font-medium"
                            >
                                {isDownloading ? (
                    ...
                    <div className="flex flex-col sm:flex-row items-center gap-4">
                        <span className="text-xs uppercase tracking-wider opacity-70 font-semibold">Share to Socials:</span>
                        ...
                        <div className="flex flex-wrap justify-center sm:justify-start gap-3">
                            ...
                            {canShare && (
                                <Button
                                    variant="outline"
                                    size="icon"
                                    className="h-10 w-10 rounded-full bg-background/80 hover:bg-background border-0 shadow-sm transition-transform hover:scale-110"
                            ...
                            <Button
                                variant="outline"
                                size="icon"
                                className="h-10 w-10 rounded-full bg-white hover:bg-blue-50 border-0 shadow-sm transition-transform hover:scale-110"
                                onClick={() => handleSocialShare('twitter')}
                                title="Share on Twitter"
                            >
                                <Twitter className="h-5 w-5 text-[#1DA1F2] fill-current" />
                            </Button>
                            ...
                            >
                                <Facebook className="h-5 w-5 text-[#4267B2] fill-current" />
                            </Button>
                            ...
                            <Button
                                variant="outline"
                                size="icon"
                                className="h-10 w-10 rounded-full bg-white hover:bg-orange-50 border-0 shadow-sm transition-transform hover:scale-110"
                            ...
                            >
                                <svg
                                    ...
                                    className="h-5 w-5 text-[#FF4500] fill-current"
                                >
                            ...
                            <Button
                                variant="outline"
                                size="icon"
                                className="h-10 w-10 rounded-full bg-white hover:bg-green-50 border-0 shadow-sm transition-transform hover:scale-110"
