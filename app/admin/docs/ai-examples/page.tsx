...
export default async function AIExamplesDocPage() {
  ...
  // 读取 Markdown 文档
  const docPath = path.join(process.cwd(), 'lib', 'ai', 'docs', 'examples.md')
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-3xl font-bold">AI API 调用示例</h1>
          <p className="text-muted-foreground">各种场景下的代码示例</p>
        </div>
