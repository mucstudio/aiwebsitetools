...
export default async function UsageExamplesDocPage() {
  ...
  // 读取 Markdown 文档
  const docPath = path.join(process.cwd(), 'lib', 'usage-limits', 'examples.md')
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-3xl font-bold">使用限制集成示例</h1>
          <p className="text-muted-foreground">如何在工具中集成使用限制</p>
        </div>
