...
export default async function UsageLimitsDocPage() {
  ...
  // 读取 Markdown 文档
  const docPath = path.join(process.cwd(), 'lib', 'usage-limits', 'README.md')
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-3xl font-bold">使用限制系统文档</h1>
          <p className="text-muted-foreground">配置和使用指南</p>
        </div>
