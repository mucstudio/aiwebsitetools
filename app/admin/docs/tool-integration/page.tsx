...
export default async function ToolIntegrationDocPage() {
  ...
  // 读取 Markdown 文档
  const docPath = path.join(process.cwd(), 'lib', 'docs', 'TOOL_INTEGRATION_GUIDE.md')
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-3xl font-bold">小工具集成指南</h1>
          <p className="text-muted-foreground">AI模型与使用限制系统集成</p>
        </div>
